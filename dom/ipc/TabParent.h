...
public:
    ...
    TabParent(ContentBridgeParent* aManager, const TabContext& aContext, uint32_t aChromeFlags);
    virtual ~TabParent();
    ...
    ContentBridgeParent* Manager() { return mManager; }
...
private:
    ...
    nsRefPtr<ContentBridgeParent> mManager;
